        ...
        <div class="home">
            <div class="home_slider_container">
                ...
                <div class="owl-carousel owl-theme home_slider">
                    ...
                    <div class="owl-item">
                        <div class="background_image" style="background-image:url('{{ url('storage/slider_image/'.$slid->slider_image) }}')"></div>
                        <div class="home_container">
                            <div class="home_container_inner d-flex flex-column align-items-center justify-content-center">
                                <div class="home_content text-center">
                                    <div class="home_subtitle">{{$slid->slider}}</div>
                                    <div class="home_title">
                                        <h1>{{$slid->title}}</h1>
                                    </div>
                                    <div class="home_link"><a href="#">{{$slid->title2}}</a></div>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <!--   <div class="owl-item">
                        <div class="background_image" style="background-image:url('frontend/images/index.jpg')"></div>
                        <div class="home_container">
                            <div class="home_container_inner d-flex flex-column align-items-center justify-content-center">
                                <div class="home_content text-center">
        ...
        <div class="featured_album">
            ...
            <div class="container">
                ...
                <div class="row featured_row row-lg-eq-height">
                    ...
                    <!-- 
                    url('{{ url('storage/slider_image/'.$slid->slider_image) }}')" -->
                    ...
                    <div class="col-md-6">
                        <div class="featured_album_image">
                            ...
                            <div class="background_image" style="background-image:url('{{ url('storage/album_image/'.$album->album_image)}}')">
                            </div>
                            @endforeach
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 artist_image_col">
                        <div class="artist_image">
                            <img src="{{url ('frontend/images/artist.png')}}" alt>
                        </div>
                    </div>
