            ...
            <div class="container">
                <div class="row discs_row">
                    ...
                    <div class="col-xl-4 col-md-6">
                        <div class="disc">
                            <a href="{{ url('albums/'.$cat->aid)}}">
                                <div class="disc_image"><img src="{{url ('storage/artist_image/'.$cat->artist_image)}}" width="350px" height="350px" alt="https://unsplash.com/@alicemoore"></div>
                                <div class="disc_container">
                                    <div>
                                        <div class="disc_content_5">
                                            <div class="disc_title">{{$cat->cat_name}}</div>
                                        </div>
                                    </div>
                                </div>
                            </a>
