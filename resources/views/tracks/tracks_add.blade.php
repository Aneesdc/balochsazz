            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-primary">
                        ...
                        <form id="" action="{{url ('admin/tracks_store')}}" enctype="multipart/form-data" method="POST">
                            @csrf
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="album_id"  class="form-control">
                                        ...
                                        <option value="{{$alb->id}}">{{$alb->album_name}}</option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="track_title" class="form-control" id="track_title" placeholder="track Name">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="track_peot" class="form-control" id="track_peot" placeholder="track_peot">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="mf_code" class="form-control" id="mf_code" placeholder="mf_code">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="upload_key" class="form-control" id="upload_key" placeholder="upload_key">
                                </div>
