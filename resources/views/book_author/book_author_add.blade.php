            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Book Author Add</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-primary">
                        ...
                        <div class="card-header">
                            <h3 class="card-title">Book Author | <small>Add</small></h3>
                        </div>
                        <form id="" action="{{url ('admin/book_author_store')}}" method="POST">
                            @csrf
                            <div class="card-body">
